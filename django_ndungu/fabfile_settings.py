...
COVERAGE_EXCLUDES = (
    ...
    '*/tests/*,*admin*,*/south_migrations/*,*/fabfile/*')
...
LOCAL_PG_ADMIN_ROLE = 'ndungu_admin'
...
def get_fab_setting(setting_name):
    if setting_name == 'SERVER_APACHE_BIN_DIR':
        return '/home/{0}/webapps/{1}/apache2/bin/'.format(
